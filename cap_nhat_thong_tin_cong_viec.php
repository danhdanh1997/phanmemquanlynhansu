...
function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "") 
{
  ...
  $Myconnection = mysqli_connect($hostname_Myconnection, $username_Myconnection, $password_Myconnection) or trigger_error(mysqlii_connect_errno(),E_USER_ERROR);
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $Result1 = mysqli_query($Myconnection,$updateSQL) or die(mysqli_connect_errno());
...
$RCcapnhat_congviec = mysqli_query($Myconnection,$query_RCcapnhat_congviec) or die(mysqli_connect_errno());
...
$RCphongban1 = mysqli_query($Myconnection,$query_RCphongban1) or die(mysqli_connect_errno());
...
$RCctcongviec1 = mysqli_query($Myconnection,$query_RCctcongviec1) or die(mysqli_connect_errno());
...
$RCChucvu1 = mysqli_query($Myconnection,$query_RCChucvu1) or die(mysqli_connect_errno());
...
$RCHocvan1 = mysqli_query( $Myconnection,$query_RCHocvan1) or die(mysqli_connect_errno());
...
$RCBangcap1 = mysqli_query( $Myconnection,$query_RCBangcap1) or die(mysqli_connect_errno());
...
$RCNgoaingu1 = mysqli_query( $Myconnection,$query_RCNgoaingu1) or die(mysqli_connect_errno());
...
$RCTinhoc1 = mysqli_query($Myconnection,$query_RCTinhoc1) or die(mysqli_connect_errno());
...
$RCDantoc1 = mysqli_query( $Myconnection,$query_RCDantoc1) or die(mysqli_connect_errno());
...
$RCQuoctich1 = mysqli_query( $Myconnection,$query_RCQuoctich1) or die(mysqli_connect_errno());
...
$RCTongiao1 = mysqli_query( $Myconnection,$query_RCTongiao1) or die(mysqli_connect_errno());
...
$RCTinhthanh1 = mysqli_query( $Myconnection,$query_RCTinhthanh1) or die(mysqli_connect_errno());
